...
create table `auth` (`uid` int primary key auto_increment, `email` varchar(50) unique not null, `password` varchar(50) not null, `userRole` varchar(50) not null);
...
CREATE TABLE `course` (  `courseid` int primary key auto_increment,  `courseName` varchar(50) unique not null, `department` varchar(50) not null);
...
create table `constants` (`key` varchar(50) primary key, `value` varchar(50) not null);
