...
public class SQLQuery {
	...
	public static final String GET_DEPARTMENT_COURSE_CATALOG = "select cc.courseid, cc.profid, cc.semester, cc.session, cc.credits from courseCatalog as cc, course as c where (cc.courseid = c.courseid and c.department = ? and profid is null)";
