...
public class ProfessorRestAPI {
	...
	private List<CourseDetail> getCourseDetail(List<String> courseids) {
		try {
			...
			for (String id : courseids) {
				...
				CourseCatalog catalog = catalogInterface.getCourseCatalog(id);
	...
	public Response viewCourses(@NotNull @QueryParam("department") String department)
	{
		ArrayList<CourseCatalog> catalog = null;
		try {
			catalog = catalogInterface.getDepartmentCourseCatalog(department);
			List<String> courseids = catalog.stream().map(cat -> cat.getCourseId()).collect(Collectors.toList());
	...
	@Path("/optedcourses")
	@Produces(MediaType.APPLICATION_JSON)
	public Response viewOptedCourses(@NotNull @QueryParam("profid") String professorId)
	{
		ArrayList<CourseCatalog> catalog = null;
	...
	@Path("/students")
	@Produces(MediaType.APPLICATION_JSON)
	public Response viewEnrolledStudents(@NotNull @QueryParam("courseid") String courseId, 
